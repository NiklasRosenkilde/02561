...
// View matrices
var modelViewLoc, texMatrixLoc, viewVectorLoc, isReflectiveLoc; 
...
window.onload = function init() {
  ...
  modelViewLoc  = gl.getUniformLocation(program, "modelViewMatrix");     //u_mvp 
  texMatrixLoc = gl.getUniformLocation(program, 'textureMatrix');        //u_mtex

  viewVectorLoc = gl.getUniformLocation(program, 'viewVector');        //u_mtex
  isReflectiveLoc  = gl.getUniformLocation(program, "isReflective");     //u_mvp 
